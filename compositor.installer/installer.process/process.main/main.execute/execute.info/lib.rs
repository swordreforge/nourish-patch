...
/// Non-interactive: print the default preset's identity + settings JSON (one per line,
/// `id<TAB>desktop_name<TAB>json`) for the single Y5 Compositor session. Used by CI.
pub fn emit_presets() {
