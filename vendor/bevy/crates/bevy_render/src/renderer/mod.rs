...
pub fn render_system(
...

    {
        ...
        world.resource_scope(|world, mut windows: Mut<ExtractedWindows>| {
            ...
            let render_queue = &world.resource::<RenderQueue>().0;
            for window in windows.values_mut() {
                ...
                if view_needs_present || window.needs_initial_present {
                    window.present(render_queue.clone());
...
pub async fn initialize_renderer(
    ...
    let instance_descriptor = wgpu::InstanceDescriptor {
        ...
        backend_options: wgpu::BackendOptions {
            ...
            noop: wgpu::NoopBackendOptions { enable: false, device_type: None, features: None, limits: None, subgroup_max_size: None, subgroup_min_size: None },
        },
    };
