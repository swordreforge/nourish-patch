...
impl Pipeline {
    pub fn new(
        ...
        // 2. Use the reference in your layout
        let layout_data = wgpu::VertexBufferLayout {
            array_stride: std::mem::size_of::<Solid>() as u64,
            step_mode: wgpu::VertexStepMode::Instance,
            attributes: ATTRIBUTES, // Use the stable reference
        };

        let layouts: Vec<Option<VertexBufferLayout<'_>>> = vec![Some(layout_data)];
